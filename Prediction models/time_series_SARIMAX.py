...
#%%
# AR method
model = SARIMAX(data['pm10'], order = (1, 1, 1), seasonal_order=(0, 0, 0, 0))
model_fit = model.fit(disp=False)
#%%
# make prediction
sarimax_predict = model_fit.predict(start=1, end=len(data))
...
plt.plot(list(range(100)),sarimax_predict[:100])
plt.show()
...
# %%
sarimax_mse = r2_score(data['pm10'],sarimax_predict )
sarimax_mse
