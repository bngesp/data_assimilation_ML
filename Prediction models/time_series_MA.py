...
#%%
# AR method
model = ARMA(data['pm10'], order = (0, 1))
model_fit = model.fit(disp=False)
#%%
# make prediction
arma_predict = model_fit.predict(start=1, end=len(data))
print(arma_predict)
...
plt.plot(list(range(100)),arma_predict[:100], marker = '*', color = 'red')
plt.show()
...
# %%
arma_mse = r2_score(data['pm10'],arma_predict )
arma_mse
